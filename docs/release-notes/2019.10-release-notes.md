...
During this development cycle we've worked on updating IPS, migrationg remaining OI-specific applications to
Python 3, rewriting some DDU closed binary blobs.
...
* IPS was synced to latest OmniOS CE version. Now it ships only Python 3.5 tools and libraries.
    - to build oi-userland after removing Python 2 pkg module you need https://github.com/OpenIndiana/oi-userland/commit/fb10babbcfd65ff74cf439bc77a2186fd79ee2a7;
...
* bash was updated
* top and htop now report compressed ARC statistics
...
* Node.js was updated to  12.13.0, 10.17.0, 8.16.2
