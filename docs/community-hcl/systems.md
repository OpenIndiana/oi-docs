...
Portions created by David Stes are Copyright (C) 2026.
...
------------ | -------------------- | ------------------ | -------------- | -------------------------------------------------- | ------------
ASUS         | PRIME B550-PLUS      | ASUS UEFI Bios 3405 | yes          | OpenIndiana 2025.04, AMD Ryzen 7 5800X CPU works, discrete graphics NVIDIA GeForce GT710 works with X11/MATE, network onboard RealTek RTL8111/8168/8211/8411 PCI Express Gigabit ethernet (rge), SATA harddisk works, tested ASUS UEFI Bios 3405 (American Megatrends 12/13/2023) system installs and boots fine both in UEFI only mode (vgatext), and in Legacy OPROM only mode (X11/MATE), kernel panic booting UEFI with X11 graphics, CSM (Compatibility Support Module) and AMD CBS (AMD Common Bios Specification) AMD IOMMU disabled   | David Stes
ASUS         | PRIME B550-PLUS      | ASUS UEFI Bios 3636 | yes          | OpenIndiana 2026.04, AMD Ryzen 5 4500 CPU works, discrete graphics ASUS NVIDIA GeForce GT730 works with X11/MATE, tested ASUS UEFI BIOS 3636 (American Megatrends 1/4/2026) system installs and boots fine both in UEFI only mode (vgatext), and in Legacy OPROM only mode (X11/MATE), kernel panic booting UEFI with X11 graphics, CSM (Compatibility Support Module) and AMD CBS (AMD Common Bios Specification) AMD IOMMU disabled   | David Stes
